...
def detect_gangerene(imageObj):
    ...
    #image read
#     image_brg = cv2.imread("C:\\Users\\germano\\Desktop\\TA\\skin_detection\\DRIVE\\04012011450.jpg")
    # image_brg = cv2.imread(imageObj)
    #read image file string data
    filestr = imageObj.file.read()
    image_brg = filestr

    #convert string data to numpy array
    npimg = np.fromstring(image_brg, np.uint8)
